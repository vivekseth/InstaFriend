...
app.get('/', function(req, res){
  res.send('Welcome to InstaFriend! please text +1 (908) 698-4131 to use. InstaFriend enjoys talking to new people! <br /><br /> Please note that all chat logs are recorded by default, so don\'t give any identifying information!<br /><br /> Made using Twilio API and PandoraBots API');
})
